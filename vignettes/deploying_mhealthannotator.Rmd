---
title: "Deploying mhealthannotator"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Deploying mhealthannotator}
...
1. ssh into the Shiny Pro server and navigate to `/home/{user}/ShinyApps/mhealthannotator-app`
1. `git pull` changes from GitHub
1. To ensure packages are up-to-date, open an R session and run `renv::restore()`
1. Note: Make sure that you have Python Environment set up. Documentation: https://python-docs.synapse.org/build/html/reticulate.html
...
1. To ensure packages are up-to-date, open an R session and run `renv::restore()`
1. Note: Make sure that your Python environment is correctly configured using reticulate with [synapseclient](https://python-docs.synapse.org/build/html/reticulate.html)
